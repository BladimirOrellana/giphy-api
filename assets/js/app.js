...
gitSharedFLink.attr('href', 'http://www.facebook.com/share.php?u='+gif[a].images.original.url+'&title='+gif[a].title );
gitSharedFLink.addClass("facebook-share float-right-share-icones");
gitRatingIcon.addClass("fa fa-star float-left");
gitRating.addClass("git-rating float-left");
gitRating.html(gif[a].rating);
gitSharedFLink.html(`<i class="fab fa-facebook-square"></i>`);
